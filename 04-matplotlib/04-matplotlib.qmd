...
However, this window blocks the Python interpreter, i.e., you cannot enter any further commands as long as the plot window is open. To avoid this behavior, you can enter the following command in the interactive Python interpreter directly after importing:
...
In contrast to using `plt.ion()` in the REPL, scripts should *not* use this command, as it can lead to unexpected behavior.
:::
